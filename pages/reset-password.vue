    ...
    <form @submit.prevent="handleResetPassword" class="space-y-4">
      <div class="relative">
        ...
        <Input id="new-password" v-model="newPassword" :type="showNewPassword ? 'text' : 'password'"
          placeholder="New Password" required class="pl-10" />
      ...
      <div class="relative">
        ...
        <Input id="confirm-new-password" v-model="confirmNewPassword"
          :type="showConfirmNewPassword ? 'text' : 'password'" placeholder="Confirm New Password" required
          class="pl-10" />
        <Icon name="lock" class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 w-4 h-4" />
