            ...
            <div>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <DynamicSelect v-model="settings.timezone" :options="timezoneOptions" placeholder="Select timezone"
                    id="timezone" />
                </div>
                <div>
                  <Label for="language">Language</Label>
                  <DynamicSelect v-model="settings.language" :options="languageOptions" placeholder="Select language"
                    id="language" />
                </div>
                <div>
                  <Label for="dateFormat">Date Format</Label>
                  <DynamicSelect v-model="settings.dateFormat" :options="dateFormatOptions"
                    placeholder="Select date format" id="dateFormat" />
                </div>
              </div>
            </div>
          </div>
