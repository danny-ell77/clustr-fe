<template>
  <div class="min-h-screen flex">
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white">
      <div class="max-w-md w-full">
        <div class="mb-8">
          ...
          <p class="text-gray-600 mt-2">Welcome to ClustR! Let's get you set up.</p>
        </div>

        <!-- Step Indicator -->
        <div class="flex justify-between mb-8 text-sm font-medium text-gray-500">
          <div :class="{'text-blue-600': currentStep === 1}">Estate Sign Up</div>
          <div :class="{'text-blue-600': currentStep === 2}">Add Users</div>
          <div :class="{'text-blue-600': currentStep === 3}">Profile Picture</div>
        </div>
    ...
    <div class="hidden lg:flex lg:w-1/2 bg-cover bg-center items-center justify-center p-8"
