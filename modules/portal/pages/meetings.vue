<template>
  <div class="p-6 space-y-4">
    ...
    <div class="grid grid-cols-3 gap-4">
      <div class="col-span-2"><MeetingCalendar :year="view.year" :month="view.month" :events="events" /></div>
    ...
    <Dialog :open="openForm" @update:open="openForm = $event">
      <DialogContent>
        ...
        <MeetingForm @submit="(m)=>{ createEvent(m); openForm=false }" />
      </DialogContent>
    </Dialog>
  </div>
</template>
...
import { useMeetings } from '~/modules/portal/runtime/composables/useMeetings'
