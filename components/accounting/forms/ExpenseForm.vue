<template>
    <div class="bg-white rounded-xl p-8">
        <h2 class="text-2xl font-semibold text-gray-900 mb-8">New Expense</h2>
        ...
        <form @submit.prevent="submitForm" class="space-y-6">
            ...
            <div class="grid grid-cols-2 gap-6">
                <div>
                    <Label for="vendor" class="text-gray-700">Vendor/Service Provider</Label>
                    <Input 
                        id="vendor" 
                        v-model="form.vendor" 
...
const { showExpenseAdded } = useSuccessModal()
...
const submitForm = async () => {
    ...
    try {
        ...
        console.log('Expense added:', form.value)
