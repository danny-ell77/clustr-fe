<template>
  <form @submit.prevent="handleSubmit" class="space-y-6">
    <h2 class="text-2xl text-gray-900 mb-4">Profile picture upload</h2>
    <div class="flex flex-col items-center space-y-4">
      ...
      <Input id="profile-picture" type="file" @change="handleFileChange" accept="image/*" class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-primary/10 file:text-primary hover:file:bg-primary/15" />
    </div>
    ...
    <div class="flex justify-between gap-4">
      <Button type="submit" class="flex-1 bg-primary text-white hover:bg-primary/90">Save</Button>
